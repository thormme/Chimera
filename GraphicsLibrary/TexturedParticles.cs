...
namespace GraphicsLibrary
{
	...
	[Serializable]
#endif
	public class TexturedParticles : DefaultTexturedQuadParticleSystem
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public TexturedParticles(Game cGame, string textureName) : base(cGame)
        {
		...
		public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
		{
			...
			InitializeTexturedQuadParticleSystem(cGraphicsDevice, cContentManager, 1000, 50000, 
												UpdateVertexProperties, "textures/particles/" + mTextureName);

			// Set the Name of the Particle System
			Name = mTextureName + "Textured Quad Particle System";
		...
		public void LoadParticleSystem()
		{
			...
			InitialProperties.VelocityMax = new Vector3(5, 10, 5);
			...
			InitialProperties.StartWidthMin = .1f;
			InitialProperties.StartWidthMax = .4f;
			InitialProperties.StartHeightMin = .1f;
			InitialProperties.StartHeightMax = .4f;
			InitialProperties.EndWidthMin = .3f;
			InitialProperties.EndWidthMax = .3f;
			InitialProperties.EndHeightMin = .3f;
			InitialProperties.EndHeightMax = .3f;
		...
		public void InitializeParticleProperties(DefaultTexturedQuadParticle cParticle)
		{
            ...
            cParticle.EndColor = Color.Black;
		}
