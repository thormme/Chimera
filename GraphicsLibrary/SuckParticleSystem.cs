...
namespace GraphicsLibrary
{
	...
	[Serializable]
#endif
	public class SuckParticleSystem : DefaultTexturedQuadParticleSystem
	{
		/// <summary>
		/// Constructor
		/// </summary>
		...
		public SuckParticleSystem(Game cGame) : base(cGame) { }
		...
		public override void AutoInitialize(GraphicsDevice cGraphicsDevice, ContentManager cContentManager, SpriteBatch cSpriteBatch)
		{
			...
			InitializeTexturedQuadParticleSystem(cGraphicsDevice, cContentManager, 1000, 50000, 
												UpdateVertexProperties, "Textures/air_particle");
		...
		public void LoadParticleSystem()
		{
			...
			InitialProperties.StartWidthMax = 4;
			InitialProperties.StartHeightMin = 1;
			InitialProperties.StartHeightMax = 4;
