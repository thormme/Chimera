...
{
    //public class CheetahLegs : DutyCyclePart
    //{
    ...
    //    protected override void BeginDuty(Vector3 direction)
    //    {
    //        mCreatureSpeed = Creature.CharacterController.HorizontalMotionConstraint.Speed;
    //        Creature.CharacterController.HorizontalMotionConstraint.Speed = RunSpeed;
    //    }

    //    protected override void EndDuty()
    //    {
